...
<template>
  <div class="app-container">
    ...
    <CompTable
      ...
      @query-table="getList">
      <template #col-customSlot="{ row }">
        //
      </template>

      <template #col-action="{ header, $index }">
...
/** 列配置 */
  const columns: TableColumn[] = [
    { prop: 'normal', label: '普通' },
    { prop: 'price', label: '价格', price: true },
    { prop: 'date', label: '日期事件', format: { type: 'date', formatStr: 'YYYY年MM月DD日 HH时mm分mm秒' } },
    { prop: 'customSlot', label: '插槽', slot: true },
    { prop: 'action', label: '自定义header', slot: true, headerSlot: true },
  ]
</script>
```
